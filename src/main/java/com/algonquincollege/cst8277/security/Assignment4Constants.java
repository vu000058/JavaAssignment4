/**
 * File: Assignment4Constants.java
 * Course materials (19W) CST 8277
 * 
 * @author (original) Mike Norman 
 * (Modified) @date 2019 03 26
 * (Modified) @author Truong Giang Vu 040-885-372
 * 
 */
...
public interface Assignment4Constants {
    ...
    public static final String SERVER_API_DESC = 
            "API resource for Employee (slightly modified from Assignment3) with Java EE 8 Security";
