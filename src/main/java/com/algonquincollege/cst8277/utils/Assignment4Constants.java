...
public interface Assignment4Constants {
    ...
    //JPA constants
    public static final String PU_NAME = "assignment4";
    ...
    public static final String CART_ITEM_TABLE_NAME = "CART_ITEM";
    ...
    public static final String SERVER_URL = "/assignment4";
    ...
    public static final String USER_CART_PATH = "/{id}/cart";
    public static final String CART_ITEM_PATH = "/{id}/item/{itemId}";
    public static final String FORBIDDEN = "{\"message\":\" You are not allowed to access this resource.\"}";
}